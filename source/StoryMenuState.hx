...
class StoryMenuState extends MusicBeatState
{
	...
	var tabiCharacter:MenuCharacter2;
	...
	override function create()
	{
		...
		tabiCharacter = new MenuCharacter2((FlxG.width * 0.25) * 1 - 150, 'tabi');
		tabiCharacter.y += 70;
		tabiCharacter.antialiasing = true;
		tabiCharacter.setGraphicSize(Std.int(tabiCharacter.width * 0.5));
		tabiCharacter.updateHitbox();
